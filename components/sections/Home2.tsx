										...
										<div className="text-secondary-2 d-flex align-items-center">
											...
											<div className="text-dark">
												<div className="typewriter">
													<h1 className="fs-6 fw-medium">Hey, I’m Arun</h1>
												</div>
											</div>
											&lt;/span&gt;
										</div>
										<h1 className="fs-50 my-3"><span className="text-linear-4">{'{'}App developer{'}'}</span><span className="flicker">_</span></h1>
										<p className="mb-6 text-secondary-2">&lt;p&gt;<span className="text-dark">With expertise in cutting-edge technologies such as</span> <span className="text-secondary-2">Android</span>, <span className="text-secondary-2">Flutter</span>, <span className="text-secondary-2">Kotlin</span>, and <span className="text-secondary-2">Dart</span><span className="text-dark">... I deliver web solutions that are both innovative and robust.</span>&lt;/p&gt;</p>
										<div className="row">
											<div className="col-7">
												{/* Carausel Scroll */}
